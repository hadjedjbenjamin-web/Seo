  ...
  return (
    <section className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <h2 className="text-4xl md:text-5xl font-bold text-center mb-32 text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-blue-900 pt-8 pb-4 leading-tight">
          {t.title}
        </h2>
